...
| `references/projects.md` | Project workflow handoffs and their human-confirmation gates; projects and their durable resources (`github_repo`, `local_directory`, worktree mode) |
