      ...
      entries: [
        {
          version: "0.6.0",
          date: "2026-09-23",
          title: "実行中タスクへの追加指示、Issue の重複マーク、より安定したタスク実行、新しいモデルの即時反映",
          changes: [],
          features: [
            "Claude Code や Codex のタスクに、実行中でも新しい指示を足せます。",
            "ステータスの選択から Issue を重複としてマークでき、元の Issue にワンクリックで移動できます。",
            "重複の関係は Issue の一覧でも Issue 自体でも見えます。",
          ...
          fixes: [
            "Claude Code と Codex の新しいモデルが、出たらすぐ選択肢に並びます。",
            "追加の指示を受け取れないタスクには、その入口が出なくなります。",
