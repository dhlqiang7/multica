 ...
 *
 * Absorbs the former standalone "Pull requests" section, so it follows the
 * same workspace switch: with the PR sidebar off there is no code group.
 * Renders nothing while there is nothing delivered.
 */
