...
import { WorkflowStatusPicker } from "./pickers/workflow-status-picker";
        ...
        {propertiesOpen && <div className="grid grid-cols-[auto_1fr] gap-x-2 gap-y-0.5 pl-2">
          ...
          <PropRow label={t(($) => $.detail.prop_status)}>
            {issue.workflow_id && issue.workflow_status_id ? (
              <WorkflowStatusPicker issue={issue} align="start" onMarkDuplicate={actions.openMarkDuplicate} />
            ) : (
              <StatusPicker status={issue.status} onUpdate={handleUpdateField} align="start" onMarkDuplicate={actions.openMarkDuplicate} />
            )}
          </PropRow>
